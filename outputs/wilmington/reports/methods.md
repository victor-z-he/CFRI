...
where:
- $Q^*_{lag}(t)$ = percentile-normalized river discharge shifted by 22 hours
...
The optimal lag (22 hours) was determined using a hybrid approach:
...
- Training period: 1995-2008 (14 years)
- Test period: 2009-2015 (7 years)

The optimal threshold (0.950) was selected via grid search
