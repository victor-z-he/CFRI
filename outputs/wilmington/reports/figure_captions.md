...
Figure 1. Compound Flood Risk Index (CFRI) performance for wilmington.
...
the optimal threshold (0.95) selected via training-period
grid search.
...
threshold (0.95, black dashed line) maximizes F1 score
...
performance (F1 = 0.264) compared to simpler baselines including
